...
//        }
        ...
        selection = new TournamentSelection<TSP_InstanceSolution>(7);

        // DEFINE NSGA_II AS THE RUNNING ALGORITHM
        algorithm = new SPEA2Builder<TSP_InstanceSolution>(problem, crossover, mutation)
        ...
        System.out.println("SPEA2 RUNNING {" + Algorithm_i + "} on " + fGridText + " [" + numOfCities + "] cities over " + generations + "generations");
        ...
        OL.setExperimentName(exName, numOfCities, "SPEA2", Algorithm_i);
